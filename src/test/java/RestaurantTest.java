...
public class RestaurantTest {
  ...
  public void getName_returnsName() {
    Restaurant newRestaurant = new Restaurant("Lardo", 1, 2);
    assertEquals("Lardo", newRestaurant.getName());
  }

  @Test
  public void equals_returnsTrueIfNamesAreTheSame() {
    Restaurant restaurant1 = new Restaurant("Lardo", 1, 2);
    Restaurant restaurant2 = new Restaurant("Lardo", 1, 2);
    assertEquals(true, restaurant1.equals(restaurant2));
  }

  @Test
  public void save_savesRestaurantToDatabase() {
    Restaurant myRestaurant = new Restaurant("Lardo", 1, 2);
    myRestaurant.save();
